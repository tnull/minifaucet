	...
	/getleaderboard				... to show the leaderboard</pre>"
        ...
        match url_parts.next() {
            ...
            Some("getleaderboard") => {
                ...
                let mut msg = "<center><meta http-equiv=\"refresh\" content=\"5\" /><table style=\"border:1px solid black;margin-left:auto;margin-right:auto;\"><tr><th>Passphrase</th><th>Time (s)</th></tr>".to_string();
